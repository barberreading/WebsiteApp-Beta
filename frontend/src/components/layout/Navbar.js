...
const AppNavbar = () => {
  ...
  // Logo SVG inline for immediate display
  const logoSvg = `
    <svg width="150" height="50" viewBox="0 0 150 50" xmlns="http://www.w3.org/2000/svg">
      <circle cx="25" cy="25" r="23" fill="#00E1E1" />
      <text x="25" y="30" font-family="Arial" font-size="16" font-weight="bold" fill="#FF40B4" text-anchor="middle">ECA</text>
      <text x="85" y="20" font-family="Arial" font-size="12" font-weight="bold" fill="#6A2C94" text-anchor="middle">Everything</text>
      <text x="85" y="35" font-family="Arial" font-size="12" font-weight="bold" fill="#FF40B4" text-anchor="middle">Childcare Agency</text>
    </svg>
  `;
          ...
          <Nav className="me-auto">
            ...
            {currentUser && (
              <>
                ...
                {/* Resources dropdown - hidden for staff users */}
